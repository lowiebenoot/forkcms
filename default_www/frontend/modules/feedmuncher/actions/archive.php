...
class FrontendFeedmuncherArchive extends FrontendBaseBlock
{
	...
	private function getData()
	{
		...
		$this->pagination['num_items'] = FrontendFeedmuncherModel::getAllForDateRangeCount($this->startDate, $this->endDate);
		...
		// get articles
		$this->items = FrontendFeedmuncherModel::getAllForDateRange($this->startDate, $this->endDate, $this->pagination['limit'], $this->pagination['offset']);
	}
