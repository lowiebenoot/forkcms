 ...
 * @since		2.1
 */
class FrontendFeedmuncherWidgetRecentArticlesFull extends FrontendBaseWidget
{
	/**
	 * Execute the extra
	 *
	...
	private function parse()
	{
		...
		// assign comments
		$this->tpl->assign('widgetFeedmuncherRecentArticlesFull', FrontendFeedmuncherModel::getAll(FrontendModel::getModuleSetting('feedmuncher', 'recent_articles_full_num_items', 5)));
	}
}
