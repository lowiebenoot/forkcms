...
class BackendFeedmuncherMassCommentAction extends BackendBaseAction
{
	...
	public function execute()
	{
		...
		else
		{
			...
			// delete comment(s)
			if($action == 'delete') BackendFeedmuncherModel::deleteComments($ids);
			...
			elseif($action == 'spam')
			{
				...
				{
					// get data
					$comments = BackendFeedmuncherModel::getComments($ids);
				...
				// set new status
				BackendFeedmuncherModel::updateCommentStatuses($ids, $action);
			}
