...
/**
 * This is the comments-action , it will display the overview of feedmuncher comments
 *
 * @package		backend
...
class BackendFeedmuncherComments extends BackendBaseActionIndex
{
	...
	{
		// reset URL
		$URL = BackendModel::getURLForBlock('feedmuncher', 'detail') . '/' . $URL . '#comment-' . $id;
	...
	private function loadDataGrids()
	{
		...
		$this->dgPublished->setColumnFunction(array('BackendFeedmuncherComments', 'addPostData'), array('[text]', '[post_title]', '[post_url]', '[id]'), 'text', true);
		...
		$this->dgModeration->setColumnFunction(array('BackendFeedmuncherComments', 'addPostData'), array('[text]', '[post_title]', '[post_url]', '[id]'), 'text', true);
		...
		$this->dgSpam->setColumnFunction(array('BackendFeedmuncherComments', 'addPostData'), array('[text]', '[post_title]', '[post_url]', '[id]'), 'text', true);
